    ...
    <main class="max-w-7xl mx-auto px-4 py-8 space-y-8">
      ...
      <header class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p class="text-sm mt-1">Ringkasan cepat aktivitas penyewaan perlengkapan hiking.</p>
        </div>

        <div class="flex flex-wrap gap-2">
          <a href="{{ route('admin.produk.create') }}" class="btn-primary text-sm">
            + Tambah Produk
          </a>
            ...
            <tbody>
              @forelse ($latestReservations as $res)
                <tr>
                  ...
                  <td class="font-semibold text-emerald-500">
              ...
              @empty
                <tr>
                  <td colspan="7" class="text-center text-gray-500 text-sm py-4">
                    Belum ada reservasi.
                  </td>
                </tr>
              @endforelse
