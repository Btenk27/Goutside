    ...
    <main class="max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        <section class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-2xl border border-amber-500/40 bg-slate-900/60 p-4">
                ...
                <p class="mt-1 text-xs text-slate-400">Reservasi dengan status <span class="font-semibold">pending</span>.</p>
            </div>
                        ...
                        @forelse ($latestReservations as $res)
                            <tr class="hover:bg-slate-900/80">
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    @endphp
                                    <span class="inline-flex items-center rounded-full border px-2 py-0.5 text-[11px] font-medium {{ $badgeColor }}">
                                        {{ ucfirst($res->status) }}
                                    </span>
                                </td>
                            </tr>
