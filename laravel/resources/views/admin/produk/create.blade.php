    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.produk.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <input type="number" name="harga" value="{{ old('harga') }}" min="0" step="1000" required
                    class="form-input w-full">
            </div>
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3" class="form-textarea w-full">{{ old('deskripsi') }}</textarea>
            </div>

            <div>
                <label class="block text-sm font-medium mb-1">Spesifikasi (opsional)</label>
                <textarea name="spesifikasi" rows="3" class="form-textarea w-full">{{ old('spesifikasi') }}</textarea>
            </div>
